-- Fix search_path for all SECURITY DEFINER functions to prevent search_path manipulation attacks

-- Update generate_api_token function
...
-- Update validate_org_api_token function
...
-- Update update_user_storage function
...
-- Update mark_first_admin_created function
...
-- Make patient-documents storage bucket private for LGPD compliance
